...
export const MOCK_LISTINGS: ListingLite[] = [
    {
        ...
        source: {
            operatorName: "Example Landing",
            operatorSiteUrl: "https://example.com",
            allowPhotos: true,
            allowLongCopy: true
        },
        isActive: true
    },
    {
        ...
        source: {
            operatorName: "Sunset Runner Charters",
            operatorSiteUrl: "https://sunset-runner.example",
            allowPhotos: true,
            allowLongCopy: false
        },
        isActive: true
    },
    {
        ...
        source: {
            operatorName: "Harbor Sportfishing",
            operatorSiteUrl: "https://harbor-sport.example",
            allowPhotos: false,
            allowLongCopy: false
        },
        isActive: true
    },
    {
        ...
        source: {
            operatorName: "OC Flyer",
            operatorSiteUrl: "https://oc-flyer.example",
            allowPhotos: true,
            allowLongCopy: true
        },
        isActive: true
    },
    {
        ...
        source: {
            operatorName: "Explorer Sportfishing",
            operatorSiteUrl: "https://explorer.example",
            allowPhotos: true,
            allowLongCopy: true
        },
        isActive: true
...
export const MOCK_SPECIES = [
    "Bluefin Tuna", "Yellowfin Tuna", "Yellowtail", "Mahi-Mahi",
    "Calico Bass", "Halibut", "Rockfish", "Bonito"
];
